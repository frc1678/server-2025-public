...
class TestExportTIM:
    def setup_method(self):
        ...
        self.test_server.local_db.insert_documents("obj_tim", TEST_TIM_DATA)
        self.test_server.local_db.insert_documents("tba_tim", TEST_TBA_TIM)
        self.test_server.local_db.insert_documents("ss_tim", TEST_SS_TIM)
...
class TestExportTeam:
    def setup_method(self):
        with mock.patch(
            ...
            self.test_server = Server()
        self.test_server.local_db.insert_documents("raw_obj_pit", TEST_RAW_OBJ_PIT)
        self.test_server.local_db.insert_documents("obj_team", TEST_OBJ_TEAM)
        self.test_server.local_db.insert_documents("subj_team", TEST_SUBJ_TEAM)
        self.test_server.local_db.insert_documents("tba_team", TEST_TBA_TEAM)
        self.test_server.local_db.insert_documents("pickability", TEST_PICKABILITY)
        self.test_server.local_db.insert_documents("pickability", TEST_SS_TEAM)
